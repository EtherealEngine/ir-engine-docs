...
1. **Select the video entity:** Ensure your video entity is active in the **Hierarchy** panel.
2. **Adjust video settings:** In the **Properties** panel, use both the **Video** and **Media** components to configure your settings. Here, you can adjust options such as playback settings, loop options, and volume control.
