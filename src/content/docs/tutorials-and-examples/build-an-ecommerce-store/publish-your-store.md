...
1. **Open the publishing menu:** In the Studio interface, locate the **Publish** button at the top right of the screen.
    ...
    ![Location of the Publish button](../../../../assets/images/tutorials-and-examples/build-an-ecommerce-store-with-shopify-integration/publish-your-store/publish-button-location.png)

2. **Configure virtual space details:**
    1. Click the **Publish** button to open the publishing menu.

        ![Configuring your Location's settings](../../../../assets/images/tutorials-and-examples/build-an-ecommerce-store-with-shopify-integration/publish-your-store/location-settings-configuration.png)
...
4. **Retrieve the link:**
    ...
    2. Copy this link to share it with your users.
        ...
        ![URL of your newly published Location](../../../../assets/images/tutorials-and-examples/build-an-ecommerce-store-with-shopify-integration/publish-your-store/published-location-url.png)
