...
Version 0.8 of the Studio moves the application from Closed Alpha to Closed Beta. This release focuses on bug fixes and UI/UX improvements to the initial Version 0.7 (Closed Alpha) release.
